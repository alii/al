...
pub fn to_string(b Binary) Option(String)
...
@vm(binary__slice)
pub fn slice(b Binary, at_bit Int, take_bits Int) Option(Binary)
...
@vm(binary__byte_at)
pub fn byte_at(b Binary, i Int) Option(Int)

...
/// A leading uppercase ASCII letter marks a type/constructor name (as opposed
/// to a value/variable name). This is the language's *only* case-sensitivity
/// rule and both the parser and the type hydrator route through it.
#[inline]

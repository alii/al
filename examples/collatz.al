...
[
	CollatzResult(start: 1, steps: collatz_length(1)),
	CollatzResult(start: 7, steps: collatz_length(7)),
	CollatzResult(start: 27, steps: collatz_length(27)),
	CollatzResult(start: 97, steps: collatz_length(97)),
]

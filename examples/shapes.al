...
[
	ShapeInfo(name: 'Circle r=10', area: circle_area(10), perimeter: circle_circumference(10)),
	ShapeInfo(
		name: 'Rectangle 5x8',
		area: rectangle_area(5, 8),
		perimeter: rectangle_perimeter(5, 8),
	),
	ShapeInfo(name: 'Square 7', area: square_area(7), perimeter: square_perimeter(7)),
]
